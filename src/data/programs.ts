...
export const PROGRAMS: Program[] = [
  {
    ...
    sessions: [
      ...
      },
      {
        ...
        isRestDay: false,
        exercises: [
          { name: 'Barre au Front', nameEn: 'skull crusher', sets: '4', reps: '10', technique: 'Coudes serrés vers l\'intérieur, ne pas les écarter.', muscle: 'Triceps', rest: '90s', position: 'Allongé sur un banc, bras verticaux tenant la barre EZ. Fléchir les coudes pour descendre la barre vers le front, puis pousser.' },
          ...
          { name: 'Dips Machine', nameEn: 'tricep dip machine', sets: '3', reps: '12', technique: 'Buste droit pour isoler les triceps.', muscle: 'Triceps', rest: '60s', position: 'Assis à la machine, poignées en mains. Pousser vers le bas en gardant les coudes près du corps.' },
          { name: 'Extension Haltère Nuque', nameEn: 'tricep overhead extension', sets: '3', reps: '12', technique: 'Garder le bras vertical, ne pas bouger le coude.', muscle: 'Triceps', rest: '60s', position: 'Debout ou assis, un haltère tenu à deux mains au-dessus de la tête. Descendre derrière la nuque en fléchissant les coudes.' }
        ],
        homeExercises: [
          ...
          { name: 'Extension Triceps Sol', nameEn: 'tricep overhead extension', sets: '3', reps: '15', technique: 'Coudes fixes, ne bouger que l\'avant-bras.', muscle: 'Triceps', rest: '45s', position: 'Allongé sur le dos, haltères ou bouteilles à la verticale. Fléchir les coudes pour descendre vers les tempes.' },
      ...
      },
      {
        ...
        isRestDay: false,
        exercises: [
          { name: 'Curl Pupitre', nameEn: 'preacher curl', sets: '3', reps: '12', technique: 'Coude appuyé sur le pupitre, pas d\'élan.', muscle: 'Biceps', rest: '60s', position: 'Assis au pupitre, coude posé sur le coussin incliné. Monter l\'haltère en supinant le poignet.' },
        ...
        homeExercises: [
          { name: 'Curl Élastique', nameEn: 'band curl', sets: '3', reps: '15', technique: 'Tension constante sur tout le mouvement.', muscle: 'Biceps', rest: '45s', position: 'Debout on the elastic. Monter les mains vers les épaules en gardant les coudes fixes.' },
    ...
    sessions: [
      {
        ...
        isRestDay: false,
        exercises: [
          { name: 'Développé Couché', nameEn: 'bench press', sets: '4', reps: '6-8', technique: 'Omoplates serrées, cage thoracique sortie.', muscle: 'Pectoraux', rest: '120s', position: 'Allongé sur banc plat, pieds au sol. Descendre la barre jusqu\'aux pectoraux en contrôlant. Pousser en explosif.' },
      ...
      },
      {
        ...
        isRestDay: false,
        exercises: [
          { name: 'Écarté Poulie', nameEn: 'cable crossover', sets: '4', reps: '15', technique: 'Focus sur la contraction en fin de mouvement.', muscle: 'Pectoraux', rest: '60s', position: 'Debout entre deux poulies hautes. Ramener les bras devant soi en arc en gardant les coudes légèrement fléchis.' },
          ...
          { name: 'Croisé Poulie Bas', nameEn: 'cable crossover low', sets: '3', reps: '15', technique: 'Ramener les mains vers le haut pour le haut des pecs.', muscle: 'Haut Pectoraux', rest: '60s', position: 'Poulies basses, ramener les bras en diagonale vers le haut et vers le centre.' },
        ...
        homeExercises: [
          { name: 'Pompes Surélevées', nameEn: 'incline push up', sets: '4', reps: 'Max', technique: 'Mains sur un livre ou une marche.', muscle: 'Pectoraux', rest: '60s', position: 'Mains posées sur un livre épais ou une marche. Corps en planche. Descendre la poitrine.' },
          ...
          { name: 'Pompes Explosives', nameEn: 'clapping push up', sets: '3', reps: '10', technique: 'Pousser fort pour décoller les mains.', muscle: 'Pectoraux', rest: '90s', position: 'Pompes classiques en poussant de façon explosive pour que les mains décollent du sol.' },
    ...
    sessions: [
      {
        ...
        isRestDay: false,
        exercises: [
          { name: 'Tractions Larges', nameEn: 'wide pull up', sets: '4', reps: 'Max', technique: 'Tirer avec les coudes vers le bas, pas avec les mains.', muscle: 'Grand dorsal', rest: '120s', position: 'Suspendu à la barre, prise large pronation. Ramener les coudes vers les hanches en contractant le dos.' },
          ...
          { name: 'Tirage Triangle', nameEn: 'v-bar pulldown', sets: '3', reps: '12', technique: 'Serre les omoplates en fin de mouvement.', muscle: 'Dos', rest: '90s', position: 'Assis à la poulie basse, poignée triangle. Tirer vers le bas ventre en serrant les omoplates.' }
        ],
        homeExercises: [
          ...
          { name: 'Gainage Latéral', nameEn: 'side plank', sets: '3', reps: '30s', technique: 'Corps aligné, hanches hautes.', muscle: 'Obliques/Dos', rest: '45s', position: 'Sur le côté, appui on a coude. Corps aligné de la tête aux pieds. Tenir la position.' }
        ]
      },
      {
        id: 'dos-2',
        ...
        isRestDay: false,
        exercises: [
          { name: 'Rowing Barre', nameEn: 'bent over row', sets: '4', reps: '8', technique: 'Dos plat à 45°, tirer vers le bas ventre.', muscle: 'Milieu dos', rest: '120s', position: 'Debout, pieds écartés, buste incliné à 45°. Barre en prise large. Tirer vers le bas ventre en serrant les omoplates.' },
          { name: 'Rowing Haltère', nameEn: 'one arm row', sets: '3', reps: '10', technique: 'Rotation du buste en fin de mouvement.', muscle: 'Dos', rest: '90s', position: 'Un genou et une main sur le banc pour le soutien. Tirer l\'haltère vers la hanche en gardant le coude près du corps.' },
        ...
        homeExercises: [
          { name: 'Rowing Élastique', nameEn: 'resistance band row', sets: '4', reps: '15', technique: 'Serre les omoplates en fin de mouvement.', muscle: 'Dos', rest: '60s', position: 'Élastique fixé à hauteur de taille. Tirer vers le ventre en gardant les coudes près du corps.' },
          ...
          { name: 'Rowing Bouteilles', nameEn: 'one arm row', sets: '3', reps: '12', technique: 'Incliner le buste, tirer avec les coudes.', muscle: 'Dos', rest: '60s', position: 'Debout, buste incliné à 45°. Bouteilles d\'eau en mains. Tirer vers les hanches.' },
    ...
    sessions: [
      {
        ...
        exercises: [
          ...
          { name: 'Développé Couché', nameEn: 'bench press', sets: '4', reps: '10', technique: 'Cage thoracique sortie, omoplates serrées.', muscle: 'Pectoraux', rest: '90s', position: 'Allongé sur banc plat. Descendre la barre jusqu\'aux pectoraux en contrôlant. Pousser en expirant.' },
      ...
      },
      {
        ...
        exercises: [
          ...
          { name: 'Développé Militaire', nameEn: 'overhead press', sets: '4', reps: '10', technique: 'Debout, gainage fort, pas de cambure.', muscle: 'Épaules', rest: '90s', position: 'Debout, barre devant les épaules. Pousser vers le haut en verrouillant les genoux et en contractant les abdos.' },
          { name: 'Rowing Haltère', nameEn: 'one arm row', sets: '3', reps: '12', technique: 'Tirer avec le coude, pas avec la main.', muscle: 'Dos', rest: '90s', position: 'Un genou sur le banc, même côté pour la main. L\'autre main tient l\'haltère. Tirer vers la hanche.' },
      ...
      },
      {
        ...
        exercises: [
          ...
          { name: 'Mollets Debout', nameEn: 'standing calf raise', sets: '4', reps: '15', technique: 'Amplitude maximale, tenir 1 seconde en haut.', muscle: 'Mollets', rest: '60s', position: 'Debout on a step ou le sol. Monter on the pointe des pieds le plus haut possible. Descendre lentement.' }
        ],
        homeExercises: [
          ...
          { name: 'Rowing Élastique', nameEn: 'resistance band row', sets: '3', reps: '15', technique: 'Tirer les coudes vers l\'arrière en serrant les omoplates.', muscle: 'Dos', rest: '60s', position: 'Élastique fixé à hauteur de taille. Tirer vers le ventre en serrant les omoplates.' },
          { name: 'Mollets Debout', nameEn: 'standing calf raise', sets: '4', reps: '20', technique: 'Monter haut, descendre bas, tenir 1 seconde en haut.', muscle: 'Mollets', rest: '45s', position: 'Debout on a marche si possible. Monter on the pointe des pieds. Descendre sous le niveau de la marche.' }
        ]
      }
    ],
    nutrition: {
    ...
    sessions: [
      {
        ...
        homeExercises: [
          ...
          { name: 'Fentes Statiques', nameEn: 'lunge', sets: '3', reps: '12 par jambe', technique: 'Genou arrière proche du sol, torse droit.', muscle: 'Quadriceps/Fessiers', rest: '60s', position: 'Un grand pas en avant. Descendre le genou arrière vers le sol. Remonter et répéter.' },
      ...
      },
      {
        ...
        exercises: [
          ...
          { name: 'Hip Thrust', nameEn: 'hip thrust', sets: '4', reps: '10', technique: 'Contracte fort les fessiers en haut, tenir 2 secondes.', muscle: 'Fessiers', rest: '90s', position: 'Épaules sur un banc, barre sur les hanches. Pousser les hanches vers le haut. Tenir 2 secondes.' }
        ],
        homeExercises: [
          ...
          { name: 'Nordic Curl', nameEn: 'nordic curl', sets: '3', reps: '8', technique: 'Descendre lentement, revenir en poussant.', muscle: 'Ischio-jambiers', rest: '90s', position: 'À genoux, pieds bloqués sous un meuble. Descendre le buste vers le sol lentement en résistant.' },
          { name: 'Mollets Debout', nameEn: 'standing calf raise', sets: '4', reps: '25', technique: 'Sur une marche, amplitude totale.', muscle: 'Mollets', rest: '45s', position: 'Debout on the bord d\'une marche. Monter on the pointe des pieds. Descendre sous le niveau.' },
    ...
    sessions: [
      {
        ...
        exercises: [
          ...
          { name: 'Roue Abdominale', nameEn: 'ab wheel', sets: '3', reps: '10', technique: 'Gainage strict, ne pas creuser le dos.', muscle: 'Abdominaux', rest: '60s', position: 'À genoux, roue en mains. Dérouler vers l\'avant en gardant le dos droit. Revenir en contractant les abdos.' }
        ],
        homeExercises: [
          { name: 'Crunch Classique', nameEn: 'crunch', sets: '4', reps: '25', technique: 'Expirer en montant, ne pas tirer on the cou.', muscle: 'Grand droit', rest: '45s', position: 'Allongé sur le dos, pieds au sol. Mains derrière la tête. Enrouler le buste vers les genoux.' },
          ...
          { name: 'Planche', nameEn: 'plank', sets: '3', reps: '1min', technique: 'Corps parfaitement aligné, ne pas laisser les hanches monter.', muscle: 'Abdominaux', rest: '60s', position: 'Appui on the avant-bras et les orteils. Corps parfaitement aligné. Contracter les abdos.' }
        ]
      },
      {
        id: 'abd-2',
        ...
        isRestDay: false,
        exercises: [
          { name: 'Gainage Planche', nameEn: 'plank', sets: '3', reps: '1min', technique: 'Corps aligné, ne pas laisser les hanches monter.', muscle: 'Transverse', rest: '60s', position: 'Appui on the avant-bras et les orteils. Corps en ligne droite. Contracter les abdos et les fessiers.' },
          { name: 'Gainage Latéral', nameEn: 'side plank', sets: '3', reps: '45s par côté', technique: 'Hanches hautes, corps aligné.', muscle: 'Obliques', rest: '45s', position: 'Sur le côté, appui on an avant-bras. Corps aligné. Lever les hanches. Tenir.' },
          { name: 'Hollow Hold', nameEn: 'hollow hold', sets: '3', reps: '45s', technique: 'Dos collé au sol, bras et jambes levés.', muscle: 'Abdominaux', rest: '60s', position: 'Allongé sur le dos. Lever bras et jambes en gardant le dos collé au sol. Creuser les abdos.' },
        ...
        homeExercises: [
          { name: 'Planche Bras Tendus', nameEn: 'high plank', sets: '3', reps: '45s', technique: 'Bras tendus, corps aligné.', muscle: 'Transverse', rest: '45s', position: 'Position de pompes. Bras tendus. Corps en planche parfaite. Tenir.' },
          { name: 'Gainage Latéral', nameEn: 'side plank', sets: '3', reps: '30s par côté', technique: 'Hanches hautes, ne pas laisser tomber.', muscle: 'Obliques', rest: '30s', position: 'Sur le côté, appui on an avant-bras. Lever les hanches. Corps aligné.' },
