  ...
  return (
    <div className="fixed inset-0 z-[100] bg-background flex flex-col animate-in slide-in-from-bottom duration-300">
      <header className="p-6 flex items-center justify-between">
        ...
        <button onClick={onClose} className="text-zinc-500 p-2 press-effect">
          <X className="w-6 h-6" />
        </button>
      </header>
        ...
        <div className="flex-1 flex flex-col p-6 fade-in">
          <div className="flex-1 flex flex-col justify-center text-center">
            <span className="text-primary font-bold text-xs uppercase tracking-widest mb-4">
              Exercice {currentExIdx + 1} / {session.exercises.length}
            </span>
            <h1 className="text-5xl font-headline text-white mb-6 leading-tight uppercase">
              {currentExercise.name}
            </h1>
            <div className="flex justify-center gap-6 mb-10">
              <div className="bg-secondary px-8 py-4 rounded-3xl pop-in stagger-1">
              ...
              <div className="bg-secondary px-8 py-4 rounded-3xl pop-in stagger-2">
            ...
            <p className="text-lg text-zinc-400 italic max-w-xs mx-auto fade-in stagger-3">
          ...
          <div className="pb-10">
            <Button
              onClick={handleNext}
              className="w-full h-20 rounded-3xl text-2xl font-headline bg-primary text-white shadow-2xl press-effect ripple"
            >
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-6 fade-in text-center">
          <div className="relative w-64 h-64 flex items-center justify-center mb-10">
            ...
            <svg className="absolute inset-0 w-full h-full -rotate-90" viewBox="0 0 100 100">
              <circle cx="50" cy="50" r="46" stroke="#E24B4A" strokeWidth="4" fill="transparent"
                strokeDasharray={289} strokeDashoffset={289 * (1 - timeLeft / 60)}
                className="transition-all duration-1000" />
            </svg>
            <div className="flex flex-col items-center">
              <svg className="w-10 h-10 mb-2 dumbbell-lift" viewBox="0 0 24 24" fill="none">
          ...
          <Button
            variant="ghost"
            onClick={() => { setIsResting(false); setTimeLeft(60); }}
            className="text-zinc-500 uppercase font-bold text-sm tracking-widest press-effect"
          >
            Passer le repos
          </Button>
        </div>
